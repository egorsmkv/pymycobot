...
class MycobotTest:
    def __init__(self):
        ...
        self.win = tkinter.Tk()
        self.win.title("Raspberry Pi myArm Test Tool")
        self.win.geometry(
            "918x511+10+10"
    ...
    def start_aging_test(self):
        ...
        self.write_log_to_Text(
            "The loop aging test needs to run for 30 minutes and will stop automatically afterward."
        )
        self.aging_stop = False
    ...
    def has_mycobot(self):
        ...
        if not self.mycobot:
            self.write_log_to_Text("myArm is not connected!!!")
            return False
        return True
